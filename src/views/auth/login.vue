       ...
       <div class="bg-white md:shadow-md sm:shadow-none rounded p-6 w-96">
            ...
            <form class="space-y-5 mt-5">
               <div class="mb-4 relative">
                ...
                <label for="email" class="label absolute mb-0 -mt-3.5 pt-4 pl-3 leading-tighter text-gray-500 text-base mt-2 cursor-text">Enter username</label>
               </div>
               ...
               <div class="relative flex items-center border border-gray-500 focus:ring focus:border-blue-500 rounded">
                ...
                <label for="password" class="label absolute mb-0 -mt-3.5 pt-4 pl-3 leading-tighter text-gray-500 text-base mt-2 cursor-text">Password</label>
